						...
						<div class="row">
							<div class="col-xs-12">
								...
								<div class="alert alert-info">
									...
									您正在【${findDorimitory.ridgepole}】栋<br/>
									您的宿舍号为:${findDorimitory.dormitoryId}
									<button class="close" data-dismiss="alert">
										<i class="icon-remove"></i>
									</button>
								</div>
								<button type="button" class="btn btn-success btn-sm" id="exportBtn">导出数据</button>
		...
		//	];	
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					datatype: "local",
					height: 250,
					colNames:[' ', '宿舍号','电价','预存款', '余额', '月使用电量','日期'],
					colModel:[
						...
						{name:'dormitoryId',index:'dormitoryId', width:60, sorttype:"int", editable: true},
						{name:'elePrice',index:'elePrice', width:60, sorttype:"int", editable: true},
						{name:'preDeposit',index:'preDeposit', width:60, sorttype:"int", editable: true},
						{name:'overage',index:'overage', width:60, sorttype:"int", editable: true},
						{name:'electricity',index:'electricity', width:60, sorttype:"int", editable: true},
						{name:'timedate',index:'timedate',width:90, editable:true, sorttype:"date",unformat: pickDate}
						], 
				...
				*/
				...
				exportBtn.onclick = function(){
					var dId = ${findDorimitory.dormitoryId};
					window.location.href = "${pageContext.request.contextPath}/electricity/simplExport.action?dId="+dId;
				};
			});
		</script>
